        ...
        public override void Draw(Graphics graphics)
        {
            ...
            if(this.Fill==true)
            {
                if (Begin.X >= End.X && Begin.Y >= End.Y)
                    graphics.FillRectangle(myBrush, End.X, End.Y, Begin.X - End.X, Begin.Y - End.Y);
                else if (Begin.X < End.X && Begin.Y > End.Y)
                    graphics.FillRectangle(myBrush, Begin.X, End.Y, End.X - Begin.X, Begin.Y - End.Y);
                else if (Begin.X < End.X && Begin.Y < End.Y)
                    graphics.FillRectangle(myBrush, Begin.X, Begin.Y, End.X - Begin.X, End.Y - Begin.Y);
                else
                    graphics.FillRectangle(myBrush, End.X, Begin.Y, Begin.X - End.X, End.Y - Begin.Y);
            }
            else
            {
                if (Begin.X >= End.X && Begin.Y >= End.Y)
                    graphics.DrawRectangle(myPen, End.X, End.Y, Begin.X - End.X, Begin.Y - End.Y);
                else if (Begin.X < End.X && Begin.Y > End.Y)
                    graphics.DrawRectangle(myPen, Begin.X, End.Y, End.X - Begin.X, Begin.Y - End.Y);
                else if (Begin.X < End.X && Begin.Y < End.Y)
                    graphics.DrawRectangle(myPen, Begin.X, Begin.Y, End.X - Begin.X, End.Y - Begin.Y);
                else
                    graphics.DrawRectangle(myPen, End.X, Begin.Y, Begin.X - End.X, End.Y - Begin.Y);
            }
